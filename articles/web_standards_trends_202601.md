...
[![](https://www.gstatic.com/devrel-devsite/prod/v6dcfc5a6ab74baade852b535c8a876ff20ade102b870fd5f49da5da2dbf570bd/chrome/images/favicon.png)Introducing the <geolocation> HTML element  |  Blog  |  Chrome for Developers](https://developer.chrome.com/blog/geolocation-html-element)
...
[![](https://github.githubassets.com/favicon.ico)AI Content Disclosureopen](https://github.com/WICG/proposals/issues/261)
...
[![](https://github.githubassets.com/favicon.ico)Proposed web platform gap: motionpending](https://github.com/w3c/a11y-tracking/issues/290)

[Scroll-Triggered Animationsのレビュー](https://github.com/w3ctag/design-reviews/issues/1167#issuecomment-3667157396 "https://github.com/w3ctag/design-reviews/issues/1167#issuecomment-3667157396")を発端として、ユーザーの好み・特性に合わせて多様な方法でモーションの制御をできるようにし、それをUA間で統一したいという提案です。
...
[https://developer.chrome.com/blog/css-wrapped-2025](https://developer.chrome.com/blog/css-wrapped-2025?hl=en "https://developer.chrome.com/blog/css-wrapped-2025?hl=en")
...
[![](https://www.gstatic.com/images/branding/product/1x/groups_32dp.png)Intent to Ship: Decouple border-width, outline-width and column-rule-width values from their corresponding style values](https://groups.google.com/a/chromium.org/g/blink-dev/c/_50sVoTmZ3I)
...
[![](https://www.gstatic.com/images/branding/product/1x/groups_32dp.png)Intent to Prototype: CSS Image Animation](https://groups.google.com/a/chromium.org/g/blink-dev/c/0kUk5-6TAfM)
...
[![](https://www.gstatic.com/images/branding/product/1x/groups_32dp.png)Intent to Prototype: named-feature() function for CSS @supports](https://groups.google.com/a/chromium.org/g/blink-dev/c/yDqCRNiGZZs/m/rHj097DdBwAJ)
...
[![](https://www.gstatic.com/images/branding/product/1x/groups_32dp.png)Intent to Prototype: CSS contrast-color()](https://groups.google.com/a/chromium.org/g/blink-dev/c/MRCj4zyxOgI)
...
[![](https://www.gstatic.com/devrel-devsite/prod/v0079f7325df1e0b784a1ccbfee37e53c0b91b20a7fc0e564436ed01ec55d2539/chrome/images/favicon.png)Support for wrapped columns in multi-column layout  |  Blog  |  Chrome for Developers](https://developer.chrome.com/blog/multicol-wrapping?hl=en)
...
[![](https://www.bram.us/favicon.ico)Using 100vw is now scrollbar-aware (in Chrome 145+, under the right conditions)](https://www.bram.us/2026/01/15/100vw-horizontal-overflow-no-more/)
...
- Subtract \[some\] scrollbars from viewport during viewport unit calculation \[354751900\] - Chromium
  - [![](https://www.gstatic.com/buganizer/img/v0/favicon.ico)Chromium](https://issues.chromium.org/issues/354751900)

破壊的変更度合いについても調査されており、0.0003143195899% のページに影響するとのことです。  
[![](https://github.githubassets.com/favicon.ico)\[css-values\] Use of 100vw is causing pointless horizontal scrollbars on some websitescss-values-3](https://github.com/w3c/csswg-drafts/issues/6026#issuecomment-1919428550)

### \[css-scrollbars-1\] Add \`scrollbar-style\` property for \`overlay\` scrollbars

[![](https://github.githubassets.com/favicon.ico)\[css-scrollbars-1\] Add \`scrollbar-style\` property for \`overlay\` scrollbarscss-scrollbars-1](https://github.com/w3c/csswg-drafts/issues/13218)
...
[![](https://ssl.gstatic.com/docs/documents/images/kix-favicon-2023q4.ico)Fluent Scrollbars Visual Spec](https://docs.google.com/document/d/1haDpb1QIh2PaLwsQD1i4WHFq_5_jSK3XK9lhgSs4WkM/edit?tab=t.0)プレビュー

### \[css-grid\] Decide on a name for `item-slack` · Issue #10884 · w3c/csswg-drafts

[https://github.com/w3c/csswg-drafts/issues/10884](https://github.com/w3c/csswg-drafts/issues/10884 "https://github.com/w3c/csswg-drafts/issues/10884")
...
- When will CSS Grid Lanes arrive? How long until we can use it? | WebKit
  - [![](https://webkit.org/favicon.png)When will CSS Grid Lanes arrive? How long until we can use it?](https://webkit.org/blog/17758/when-will-css-grid-lanes-arrive-how-long-until-we-can-use-it/)

### Blink: Intent to Ship: meta name="text-scale"

[![](https://www.gstatic.com/images/branding/product/1x/groups_32dp.png)Intent to Ship: meta name="text-scale"](https://groups.google.com/a/chromium.org/g/blink-dev/c/0yp2ygJK5HE)
...
[![](https://www.gstatic.com/images/branding/product/1x/groups_32dp.png)Intent to prototype: ariaNotify](https://groups.google.com/a/mozilla.org/g/dev-platform/c/7UOkFqbeH7o/m/IozzYfuGAAAJ)

Chrome 141から利用可能になるとして[9月に取り上げた](https://zenn.dev/cybozu_frontend/articles/web_standards_monthly_202509#aria-notify "https://zenn.dev/cybozu_frontend/articles/web_standards_monthly_202509#aria-notify")ariaNotifyが、GeckoでもIntent to Prototypeになりました。

### aria-current and scrolling...

[![](https://github.githubassets.com/favicon.ico)aria-current and scrolling...open](https://github.com/w3c/css-aam/issues/15)
...
その後ariaのリポジトリにも[issue](https://github.com/w3c/aria/issues/2710 "https://github.com/w3c/aria/issues/2710")が立てられ、[先日のミーティング](https://www.w3.org/2026/01/29-aria-minutes.html#dbf4 "https://www.w3.org/2026/01/29-aria-minutes.html#dbf4")で提案通りの内容で合意が取られました。

また、[![](https://github.githubassets.com/favicon.ico)clarify css generated content alternative textagenda](https://github.com/w3c/css-aam/issues/16) のような、CSSのcontentプロパティの代替テキストとaccname仕様についてのissueが挙がっていたりと、TPAC以来試しに再始動しているcss-aamリポジトリが利用される動きが出ています。
...
[![](https://github.githubassets.com/favicon.ico)iso8601 as DateTimeFormat calendars: discuss](https://github.com/tc39/ecma402/issues/1036)
...
[![](https://github.githubassets.com/favicon.ico)Add \`kilowatt-hour\` unit to Intl.NumberFormatc: numbers](https://github.com/tc39/ecma402/issues/739)
...
[このプロポーザル自体が主に電気自動車や電力消費の表示のニーズからスタートしている](https://github.com/tc39/ecma402/issues/739 "https://github.com/tc39/ecma402/issues/739")ことも踏まえ、用途をこれらに限定し、CLDRに対してで優先度の高い単位を検討してもらってからサポートする単位を検討する方針で合意されました。

#### Intl Era Month Code : 複数あるイスラム暦の扱いの最終結論

[![](https://github.githubassets.com/favicon.ico)Normative: Ignore "islamic-rgsa" calendar in DateTimeFormathas consensus](https://github.com/tc39/proposal-intl-era-monthcode/issues/99)

2025年11月の会議において合意された結論を元に、Temporalがサポートする暦のリストを「閉じたリスト」（Closed Set / エンジンの拡張を許さないセット）とし、islamic-rgsaカレンダーは含めないことで合意しました。

参考 : 2025年11月の会議における議論については去年の「Web 標準動向 2025年12月版」でも触れています。

[![](https://static.zenn.studio/images/logo-transparent.png)Web 標準動向 2025年12月版](https://zenn.dev/cybozu_frontend/articles/web_standards_trends_202512#ecma402)

#### Be explicit about the Gregorian to Meiji switchover month and day in the Japanese calendar

[![](https://github.githubassets.com/favicon.ico)Normative: Be explicit about the Gregorian to Meiji switchover month and day in the Japanese calendarclosed](https://github.com/tc39/proposal-intl-era-monthcode/issues/86)
...
[![](https://github.githubassets.com/favicon.ico)tc39/proposal-iterator-sequencing](https://github.com/tc39/proposal-iterator-sequencing?tab=readme-ov-file)
...
[![](https://github.githubassets.com/favicon.ico)tc39/proposal-import-text](https://github.com/tc39/proposal-import-text)
...
[![](https://github.githubassets.com/favicon.ico)tc39/proposal-composites](https://github.com/tc39/proposal-composites)
...
[![](https://github.githubassets.com/favicon.ico)tc39/proposal-amount](https://github.com/tc39/proposal-amount)

数字と単位を持つオブジェクトです。

一度取り下げた単位の変換に再チャレンジしています。

CLDR が持つ SI 単位系を対象にし、計算については一旦言及なしです。

## Baseline

### 📃 January 2026 release notes

[https://web-platform-dx.github.io/web-features-explorer/release-notes/january-2026/](https://web-platform-dx.github.io/web-features-explorer/release-notes/january-2026/ "https://web-platform-dx.github.io/web-features-explorer/release-notes/january-2026/")

## Misc

### PSA: Overscroll effect on non-root scrollers

[![](https://www.gstatic.com/images/branding/product/1x/groups_32dp.png)Web-Facing Change PSA: Overscroll effect on non-root scrollers](https://groups.google.com/a/chromium.org/g/blink-dev/c/0rMc8bTNVCo)
...
[https://www.bram.us/2026/01/16/chrome-145-adds-experimental-support-for-vertical-tabs/](https://www.bram.us/2026/01/16/chrome-145-adds-experimental-support-for-vertical-tabs/ "https://www.bram.us/2026/01/16/chrome-145-adds-experimental-support-for-vertical-tabs/")
...
[![](https://blog.google/favicon.ico)Joint statement from Google and Apple](https://blog.google/company-news/inside-google/company-announcements/joint-statement-google-apple/)

Apple のプラットフォーム（特に Siri）に Google の Gemini が統合されることが、共同声明として正式に発表されました。

### Mozilla Localization in 2025 – Mozilla L10N

[![](https://blog.mozilla.org/l10n/wp-content/themes/frontierline/img/favicon.png)Mozilla Localization in 2025 – Mozilla L10N](https://blog.mozilla.org/l10n/2026/01/07/mozilla-localization-in-2025/)

### EPUB and HTML - Survey results and next stepsEPUB and HTML - Survey results and next steps

[![](https://www.w3.org/assets/logos/w3c-2025/favicons/favicon-32.png)EPUB and HTML - Survey results and next steps](https://www.w3.org/blog/2026/epub-and-html-survey-results-and-next-steps/)

長年議論されていた「EPUBのベースをXMLからHTMLへ移行する」提案が、出版エコシステムの既存資産（XMLベースのワークフロー）との乖離が大きすぎるとして見送りとなりました。

### 2025 Web Almanac

[https://almanac.httparchive.org/ja/2025/](https://almanac.httparchive.org/ja/2025/)
...
[https://www.igalia.com/2026/01/05/Doing-Our-Share-for-the-Web-in-2025.html](https://www.igalia.com/2026/01/05/Doing-Our-Share-for-the-Web-in-2025.html)
...
[https://www.mnot.net/blog/2026/01/20/open_web](https://www.mnot.net/blog/2026/01/20/open_web)
